 ...
 * {@link org.apache.calcite.rel.core.Sort} to be incorporated in an index scan,
 * it makes the use of operators requiring sorted inputs easier
 * and it can reduce the size of the relations being sorted.
 */
